...
function App() {
  ...
  const getData = async () => {
    try {
      const response = await axios.get("https://pokedex-production-5ef1.up.railway.app/pokedata");
  ...
  const postOwner = async (data) => {
    try {
      const response = await axios.post("https://pokedex-production-5ef1.up.railway.app/owner", data);
